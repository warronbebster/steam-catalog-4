/*
 ...
 MyFonts Webfont Build ID 2945753, 2014-12-30T11:16:05-0500
 ...
 Webfont: CenturyOSMTStd-Italic by Monotype 
 URL: http://www.myfonts.com/fonts/mti/century-os-mt/std-italic/

 Webfont: CenturyOSMTStd by Monotype 
 URL: http://www.myfonts.com/fonts/mti/century-os-mt/std-regular/

 Webfont: CenturyOSMTStd-Bold by Monotype 
 URL: http://www.myfonts.com/fonts/mti/century-os-mt/std-bold/


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2945753
 Licensed pageviews: 250,000
 Webfonts copyright: Copyright The Monotype Corporation. All rights reserved.

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2cf2d9";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0,woff2Enabled=1;
...
for(var fonts=[{fontFamily:"CenturyOldStyle",fontWeight:"normal",fontStyle:"italic",url:wfpath+"2CF2D9_0"+suffix+"_0."+webfontType},{fontFamily:"CenturyOldStyle",fontWeight:"normal",fontStyle:"normal",url:wfpath+"2CF2D9_1"+suffix+"_0."+webfontType},{fontFamily:"CenturyOldStyle",fontWeight:"bold",fontStyle:"normal",url:wfpath+"2CF2D9_2"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?
